...
<div id="woofirstpurchase-popup-container-first" style="transform: scale(0.5); bottom: -5%;">
    <form id="woofirstpurchase-main-popup-form" method="post" action="">
        ...
        <button type="submit" id="woofirstpurchase-popup-first-button" class="woofirstpurchase-popup-disappear-group"><div class="close" id='close'>Спасибо!</span></button>
        <div id="close" class="woofirstpurchase-popup-disappear-group">Закрыть окно</div>
